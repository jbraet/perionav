...
#[rstest]
fn test_small_sub_components_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
#[rstest]
fn test_sub_components_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
#[rstest]
fn test_disconnected_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
#[rstest]
fn test_semi_connected_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
#[rstest]
fn test_square_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
#[rstest]
fn test_legs_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
#[rstest]
fn test_diamond_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
#[rstest]
fn test_strongly_disconnected_graph(#[values(AlgorithmType::PATHBASED, AlgorithmType::KOSARAJU)] algorithm_type:AlgorithmType) {
...
fn test_algorithms_equal() {
    let nodes = 150000;
    let mut g = create_graph::create_random_graph(nodes, nodes*3);

    let subset = HashSet::from([1,2,4,6,7]);
    g.keep_nodes(&subset);
